	...
	$.extend(Plugin.prototype, {
			...
			bindValues: function(values){
				...
				if (this.settings.setReadonly)
					this.checkStatusFieldReadonly([$address, $neighborhood, $city, $state, $complement]);
				
					if (this.settings.setDisabled)
					this.checkStatusFieldDisabled([$address, $neighborhood, $city, $state, $complement]);
			},
			checkStatusFieldReadonly: function(fields) {
				var i = fields.length,
					$field,
					val;
				while (i--) {
			...
			checkStatusFieldDisabled: function(fields) {
				var i = fields.length,
					$field,
					val;
				while (i--) {
