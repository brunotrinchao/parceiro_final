...
class Inicial{
    ...
    function getHeader(){
        ...
        $html .= '<link href="_assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />';
        $html .= '<link href="_assets/css/style.css" rel="stylesheet" type="text/css" />';
        $html .= '<link href="_assets/css/font-awesome.css" rel="stylesheet">';
        $html .= '<link rel="stylesheet" href="_assets/css/icon-font.min.css" type="text/css" />';
        $html .= '<link href="_assets/css/animate.css" rel="stylesheet" type="text/css" media="all">';
        ...
        $html .= '<link rel="stylesheet" href="_assets/js/plugins/sweetalert2/sweetalert2.min.css">';
        $html .= '<script src="_assets/js/jquery-1.10.2.min.js"></script>';
        $html .= '</head>';
    ...
    function getFooter(){
        ...
        $html .= '</footer>';
        $html .= '<script src="_assets/js/jquery.nicescroll.js"></script>';
        $html .= '<script src="_assets/js/bootstrap.min.js"></script>';
        $html .= '<script src="_assets/js/plugins/sweetalert2/sweetalert2.all.min.js"></script>';
        $html .= '<script src="_assets/js/jquery.mask.js"></script>';
        $html .= '<script src="_assets/js/functions/functions.js"></script>';
        $html .= '<script src="_assets/js/functions/gValidate.js"></script>';
        $html .= '<script src="_assets/js/functions/api.js"></script>';
        $html .= '<script src="_assets/js/scripts.js"></script>';
        $html .= '</body>';
        $html .= '</html>';
        $html .= '</div>';
        $html .= '</div>';
